...
/*!
  ...
  @warning The class is aimed at integration of some distribution over phase space of decaying particle. In the end you would probably like to properly normalize distributions.
